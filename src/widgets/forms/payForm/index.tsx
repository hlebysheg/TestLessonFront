...
import { $errorBankName, $errorBik, $errorCheckingAccount, $errorCorrespondentAccount, $payForm, changedBankName, changedBik, changedCheckingAccount, changedCorrespondentAccount, organisationSubmit, sendData } from '@/features';
import { StyledButton, StyledCard, StyledForm, StyledFormColumn, StyledInput, StyledText } from '@/widgets';
