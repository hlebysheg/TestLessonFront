...
import { $errorFull, $errorRegisterDate, $errorRegisterDateOrganisation, $errorShort, $organisationForm, $standartForm, changedOrganisationFullName, changedOrganisationShortName, changedRegisterDate, changedRegisterDateOrganisation } from '@/features';
import { StyledDateInput, StyledForm, StyledFormColumn, StyledInput } from '@/widgets';
