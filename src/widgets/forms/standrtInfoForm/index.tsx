...
import { $errorEgripFile, $errorInn, $errorInnFile, $errorOgrip, $errorOgripFile, $errorRegisterDate, $errorRentFile, $standartForm, changedEgripFile, changedInn, changedInnFile, changedIsDoc, changedOgrip, changedOgripFile, changedRegisterDate, changedRentFile } from '@/features';
import { FileInput, StyledCheckBox, StyledDateInput, StyledForm, StyledFormColumn, StyledInput, StyledText } from '@/widgets';
