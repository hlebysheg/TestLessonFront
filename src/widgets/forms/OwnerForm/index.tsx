...
const InputGroup = styled.div`
    ...
    gap: 12px;
`;
const options = SelectModeValues.map(el => <option key={el.value} value={el.value}>{el.description}</option>)
    ...
    return (
        <StyledCard>
            ...
            <InputGroup>
                ...
                <StyledSelect disabled={isPayMode} id ='selectedMode' value={formMode} onChange={onSelectChange}>
                    {options}
                </StyledSelect>
            </InputGroup>
        </StyledCard>
